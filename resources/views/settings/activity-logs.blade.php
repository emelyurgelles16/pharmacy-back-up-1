...
<style>
    /* ============================================
       🎯 STANDARDIZED FONT SIZES - ACTIVITY LOGS
       ============================================ */
    ...
    .filter-bar .form-control:focus {
        border-color: #0b7a33;
        box-shadow: 0 0 0 3px rgba(11, 122, 51, 0.12);
    }
    ...
    .user-avatar-sm.green { background: #28a745; }
    .user-avatar-sm.blue { background: #007bff; }
    .user-avatar-sm.orange { background: #fd7e14; }
    .user-avatar-sm.purple { background: #6f42c1; }
    .user-avatar-sm.red { background: #dc3545; }
    .user-avatar-sm.teal { background: #20c997; }
...
$(document).ready(function() {
    ...
    $('#exportBtn').click(function() {
        ...
        const url = '{{ route("activity-logs.export") }}?' + params;
